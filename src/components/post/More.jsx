    ...
    <div>
      ...
      <div className="more-footer container">
        <p>
          ...
          DevOps. Nanotechnology immersion along the information <br />
          <br />
          <br />
          <br /> Leverage agile frameworks to provide a robust synopsis for high
          level overviews. Iterative approaches to corporate strategy foster
          collaborative thinking to further the overall value proposition.
          Organically grow the holistic world view of disruptive innovation via
          workplace diversity and empowerment. <br />
          <br />
          <br />
          <br /> Leverage agile frameworks to provide a robust synopsis for high
          level overviews. Iterative approaches to corporate strategy foster
          ...
          provide a robust synopsis for high level overviews. approaches to
